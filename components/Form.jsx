      ...
      >
        <label>
          ...
          <textarea
            ...
            required
            className="w-full flex rounded-lg h-[250px] mt-2 p-3 text-sm text-gray-500 outline-blue-400"
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            placeholder="#tag"
            required
            className="w-full flex rounded-lg mt-2 p-3 text-sm text-gray-500 outline-blue-400"
          />
        </label>
